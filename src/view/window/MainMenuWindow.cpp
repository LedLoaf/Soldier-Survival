...
<<<<<<< HEAD
	selectionView = new SelectionView(250, 300, 200, 500, SelectionViewModel::SIMPLE_MENU);
...
void MainMenuWindow::onEnterPressed() {
	...
	if (optionAction == util::Util::RUN_LEVEL_SELECTION)
        ...
        game::LevelDescription* sampleLevel = new game::LevelDescription(100, 100, 0.005, 9, 
